...
class SubmissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create submission" do
    assert_difference('Submission.count') do
      post submissions_url, params: { submission: { problem: @submission.problem, repos_url: @submission.repos_url, tag: @submission.tag } }
    end
  ...
  test "should update submission" do
    patch submission_url(@submission), params: { submission: { problem: @submission.problem, repos_url: @submission.repos_url, tag: @submission.tag } }
